...
//maze picture. here are a lot of scary sounds: http://bit.ly/scary­sounds

//JApplet.newAudioClip(getClass().getResource("scream.wav"));

System.out.println("BOO!");

//7. find a scary sound and put it in the "default package" where you put your

//AudioClip sound =

//8. play the scary sound. Hint: type "sound" and then a period.

//9. drop an image into your default package, and use the showScaryImage
showScaryImage("scary_clown_faces-1.jpg");
